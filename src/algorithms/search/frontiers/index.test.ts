import { createFrontierFor } from '.'

describe('DFS frontier', () => {
  const f = createFrontierFor['depth-first']({})
...
describe('BFS frontier', () => {
  const f = createFrontierFor['breadth-first']({})
...
describe('GBFS frontier', () => {
  const f = createFrontierFor['greedy best-first']({ goal: { x: 4, y: 4 } })
